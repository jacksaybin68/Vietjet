      ...
      <div className="max-w-7xl mx-auto px-3 md:px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <h2 className="mt-2 text-xl font-black tracking-tight text-navy  sm:text-2xl md:text-3xl">
              Săn vé giá rẻ mỗi ngày
            </h2>
          </div>
          <div className="flex items-center gap-1 md:gap-2">
            {DEALS.length > 0 && (
              <span className="text-[10px] md:text-xs text-vj-muted /60">
                {DEALS.length} ưu đãi
              </span>
            )}
          </div>
        ...
        <div className="md:hidden mt-3 text-center reveal-up" style={{ transitionDelay: '450ms' }}>
          <Link
            href="/tim-ve"
            className="inline-flex items-center gap-1.5 text-[11px] font-bold text-primary [#FFDD00] transition-all duration-200 border px-3 py-1.5 rounded-md hover:shadow-md hover:scale-105 active:scale-95"
            style={{
