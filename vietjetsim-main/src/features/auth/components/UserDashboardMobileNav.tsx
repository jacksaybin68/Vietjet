    ...
    <>
      <div className="flex items-center gap-3 mb-4 lg:hidden">
        <button
          ...
          className="flex items-center gap-2 bg-white border border-[rgb(var(--accent-rgb))]/30 rounded-2xl px-4 py-2.5 text-sm font-semibold shadow-sm"
          style={{ color: '#d97706' }}
        >
        ...
        <button
          ...
          className="relative ml-auto flex items-center justify-center w-10 h-10 bg-white border border-[rgb(var(--accent-rgb))]/30 rounded-2xl shadow-sm"
          title="Thông báo"
        >
      ...
      {drawerOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          >
            ...
            <div className="px-3 py-4 border-t border-[rgb(var(--accent-rgb))]/20 [rgb(var(--accent-rgb))]/30">
              {onLogout ? (
                <button
                  type="button"
                  onClick={onLogout}
                  className="flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-semibold transition-all w-full text-[var(--accent-dark)] [var(--accent-light)] hover:bg-red-50 :bg-red-900/10 hover:text-red-600 :text-red-400 cursor-pointer"
                >
                  <Icon
                ...
                <Link
                  href="/dang-nhap"
                  className="flex items-center gap-3 px-4 py-3.5 rounded-2xl text-sm font-semibold transition-all text-[var(--accent-dark)] [var(--accent-light)] hover:bg-red-50 :bg-red-900/10 hover:text-red-600 :text-red-400"
                >
                  <Icon
                    name="ArrowRightOnRectangleIcon"
                    size={20}
