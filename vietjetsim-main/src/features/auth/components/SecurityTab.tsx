          ...
          {step === 'setup' && (
            <div className="space-y-4 text-center">
              ...
              <div className="flex justify-center my-4">
                <div className="w-48 h-48 bg-[var(--surface-2)] rounded-xl flex items-center justify-center border-2 border-dashed border-[var(--border)] ">
                  {uri ? (
                    ...
                    <Icon name="QrCodeIcon" size={48} className="text-[var(--foreground-subtle)]" />
                  )}
                </div>
              </div>

              <div className="bg-[var(--surface-2)] rounded-xl p-4 text-left">
                <p className="text-xs text-[var(--foreground-muted)] [var(--foreground-muted)] font-semibold mb-1 font-[Be Vietnam Pro,sans-serif]">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  onClick={onClose}
                  className="px-6 py-3 bg-[var(--surface-2)] text-[var(--foreground-muted)] [var(--foreground-muted)] rounded-xl font-semibold font-[KoHo,sans-serif] hover:bg-[var(--surface-3)] transition-all"
                >
                  Hủy
                </button>
              </div>
    ...
    <div className="space-y-6 p-4">
              ...
              {twoFA?.isEnabled ? (
                <>
                  <button
                    ...
                    className="px-4 py-2 bg-[var(--surface-2)] text-[var(--foreground-muted)] [var(--foreground-muted)] rounded-lg text-sm font-semibold font-[KoHo,sans-serif] hover:bg-[var(--surface-3)] transition-all"
                  >
                    Cập nhật
                  </button>
                  <button
                    ...
                    className="px-4 py-2 bg-red-50 /10 text-red-600  rounded-lg text-sm font-semibold font-[KoHo,sans-serif] hover:bg-red-100 :bg-red-900/20 transition-all disabled:opacity-50"
                  >
                    Tắt 2FA
                  </button>
                </>
      ...
      <div className="bg-[var(--surface)] rounded-2xl border border-[var(--border)] overflow-hidden shadow-vj-card">
        ...
        <div className="divide-y divide-[var(--border)]">
          {sessions.length === 0 ? (
            <div className="p-6 text-center text-[var(--foreground-muted)] [var(--foreground-muted)] text-sm font-[Be Vietnam Pro,sans-serif]">
            ...
            history.map((item) => (
              <div key={item.id} className="p-4 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-[var(--foreground-muted)] [var(--foreground-muted)] mt-0.5 font-[Be Vietnam Pro,sans-serif]">
