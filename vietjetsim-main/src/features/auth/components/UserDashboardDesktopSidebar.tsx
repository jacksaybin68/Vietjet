  ...
  return (
    ...
    >
      ...
      >
        ...
        {!sidebarCollapsed && (
          <div className="px-3 py-3 border-t border-[rgb(var(--accent-rgb))]/20 [rgb(var(--accent-rgb))]/30">
            {onLogout ? (
              <button
                type="button"
                onClick={onLogout}
                className="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold text-[var(--accent-dark)] [var(--accent-light)] hover:bg-red-50 :bg-red-900/10 hover:text-red-600 :text-red-400 transition-all w-full cursor-pointer"
              >
              ...
              <Link
                href="/dang-nhap"
                className="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold text-[var(--accent-dark)] [var(--accent-light)] hover:bg-red-50 :bg-red-900/10 hover:text-red-600 :text-red-400 transition-all"
              >
                <Icon name="ArrowRightOnRectangleIcon" size={20} className="text-[var(--accent)]" />
                <span>Đăng xuất</span>
              </Link>
        ...
        {sidebarCollapsed && (
          <div className="px-2 py-3 border-t border-[rgb(var(--accent-rgb))]/20 [rgb(var(--accent-rgb))]/30">
            {onLogout ? (
              <button
                type="button"
                onClick={onLogout}
                title="Đăng xuất"
                className="flex items-center justify-center w-full py-3 rounded-2xl text-[var(--accent-dark)] [var(--accent-light)] hover:bg-red-50 :bg-red-900/10 hover:text-red-600 :text-red-400 transition-all cursor-pointer"
              >
              ...
              <Link
                href="/dang-nhap"
                title="Đăng xuất"
                className="flex items-center justify-center w-full py-3 rounded-2xl text-[var(--accent-dark)] [var(--accent-light)] hover:bg-red-50 :bg-red-900/10 hover:text-red-600 :text-red-400 transition-all"
              >
                <Icon name="ArrowRightOnRectangleIcon" size={20} />
              </Link>
            )}
