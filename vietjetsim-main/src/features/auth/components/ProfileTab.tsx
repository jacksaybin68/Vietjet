...
export default function ProfileTab({ user }: { user: User }) {
  ...
  const inputDisabledClass =
    'bg-[var(--surface-2)] text-[var(--foreground-muted)] [var(--foreground-muted)] cursor-not-allowed';
  const inputErrorClass = 'border-[var(--primary)] bg-red-50 /10';
  const labelClass =
    'block text-sm font-medium mb-1.5 font-[KoHo,sans-serif] text-[var(--foreground)] [var(--foreground)]';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          ...
          >
            ...
            {user.createdAt && (
              <p className="text-xs text-[var(--foreground-subtle)] [var(--foreground-subtle)] mt-4 font-[Be Vietnam Pro,sans-serif]">
                Tham gia từ{' '}
        ...
        <div className="lg:col-span-2">
          ...
          >
            <div className="p-6 border-b border-[var(--border)] ">
              <h3 className="text-lg font-bold font-[KoHo,sans-serif] flex items-center gap-2 text-[var(--foreground)] [var(--foreground)]">
              ...
              {isEditing && (
                <div className="flex items-center gap-3 pt-4 border-t border-[var(--border)] ">
                  ...
                  <button
                    ...
                    disabled={isSaving}
                    className="px-6 py-2.5 bg-[var(--surface-2)] text-[var(--foreground-muted)] [var(--foreground-muted)] rounded-xl font-semibold text-sm font-[KoHo,sans-serif] hover:bg-[var(--surface)] transition-all duration-200 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Hủy
                  </button>
                </div>
