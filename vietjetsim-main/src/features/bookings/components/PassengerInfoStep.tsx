        ...
        <div className="flex flex-col gap-3 sm:gap-4 mb-4 sm:mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <h2 className="font-black text-[var(--foreground)] [var(--foreground)] text-lg sm:text-xl font-koho uppercase tracking-wide">
                Thông tin hành khách
              </h2>
            </div>
            <span className="text-[10px] sm:text-xs font-bold text-white bg-[var(--vj-navy)] [var(--primary)] px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-md self-start sm:self-auto">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className={`form-field-float ${p.name ? 'has-value' : ''}`}>
                      <input
                        ...
                        placeholder=" "
                        className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-[var(--surface-2)] border border-[var(--border)] rounded-xl text-[var(--foreground)] [var(--foreground)] text-sm font-semibold form-input uppercase tracking-wide ${p.name.trim().length >= 2 ? 'form-input-valid' : ''}`}
                        required
                      />
