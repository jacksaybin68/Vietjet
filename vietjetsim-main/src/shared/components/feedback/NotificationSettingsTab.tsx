        ...
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            ...
            <p className="text-sm text-[var(--foreground-muted)]">
              Tuỳ chỉnh loại thông báo và phương thức nhận
            </p>
          </div>
        </div>
      </div>
          ...
          {alerts.map((alert) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p
                    className={`text-sm font-semibold ${alert.enabled ? 'text-[#1A2948]' : 'text-[var(--foreground-subtle)] [var(--foreground-subtle)]'}`}
                  >
                    {alert.label}
                  </p>
                  <p className="text-xs text-[var(--foreground-muted)] mt-0.5 max-w-xs">
                    {alert.description}
                  </p>
                </div>
              </div>
          ...
          {deliveryMethods.map((method) => (
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p
                    className={`text-sm font-semibold ${method.enabled ? 'text-[#1A2948]' : 'text-[var(--foreground-subtle)] [var(--foreground-subtle)]'}`}
                  >
                    {method.label}
                  </p>
