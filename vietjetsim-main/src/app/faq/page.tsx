...
const FAQ_DATA: FAQItem[] = [
  { id: 1, category: 'Chung', question: 'VietjetSim là gì?', answer: 'VietjetSim là nền tảng mô phỏng đặt vé máy bay trực tuyến, giúp người dùng trải nghiệm quy trình tìm kiếm, đặt vé, chọn ghế và thanh toán giống như thực tế.' },
  { id: 2, category: 'Đặt vé', question: 'Làm thế nào để đặt vé trên VietjetSim?', answer: 'Bạn chỉ cần truy cập trang chủ, nhập điểm đi, điểm đến, ngày bay và số lượng hành khách. Sau đó chọn chuyến bay phù hợp, điền thông tin hành khách và hoàn tất thanh toán.' },
  ...
  { id: 4, category: 'Thanh toán', question: 'VietjetSim chấp nhận những phương thức thanh toán nào?', answer: 'Chúng tôi hỗ trợ thanh toán qua thẻ ATM nội địa, thẻ tín dụng/ghi nợ quốc tế (Visa, Mastercard, JCB), ví điện tử (MoMo, ZaloPay, VNPay) và chuyển khoản ngân hàng.' },
  ...
  { id: 6, category: 'Hoàn tiền', question: 'Chính sách hoàn vé của VietjetSim như thế nào?', answer: 'Vé có thể được hoàn tùy theo điều kiện của từng hạng vé. Vé Eco thường không được hoàn, trong khi vé Deluxe và SkyBoss được hoàn với phí xử lý nhất định.' },
