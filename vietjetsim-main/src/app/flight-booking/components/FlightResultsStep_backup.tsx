  ...
  const fetchFlights = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        // #region agent log
        fetch('http://127.0.0.1:7465/ingest/4f40219d-db96-4bdd-83d7-39741c3ced27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9c0c98'},body:JSON.stringify({sessionId:'9c0c98',location:'FlightResultsStep.tsx:391',message:'sessionStorage raw',data:{raw:stored},timestamp:Date.now()})}).catch(()=>{});
        // #endregion
        if (stored) {
      ...
      // #region agent log
      fetch('http://127.0.0.1:7465/ingest/4f40219d-db96-4bdd-83d7-39741c3ced27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9c0c98'},body:JSON.stringify({sessionId:'9c0c98',location:'FlightResultsStep.tsx:411',message:'API request',data:{searchUrl,hasSession:sessionHasData,from:fromCode,to:toCode},timestamp:Date.now()})}).catch(()=>{});
      // #endregion
      const res = await fetch(searchUrl);
      // #region agent log
      fetch('http://127.0.0.1:7465/ingest/4f40219d-db96-4bdd-83d7-39741c3ced27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9c0c98'},body:JSON.stringify({sessionId:'9c0c98',location:'FlightResultsStep.tsx:413',message:'API response',data:{status:res.status,ok:res.ok,url:res.url},timestamp:Date.now()})).catch(()=>{});
      // #endregion
