...
export default function FlightBookingClient() {
  ...
  const handleFlightSelect = (flight: Flight) => {
    // #region agent log
    fetch('http://127.0.0.1:7465/ingest/4f40219d-db96-4bdd-83d7-39741c3ced27',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'9c0c98'},body:JSON.stringify({sessionId:'9c0c98',location:'FlightBookingClient.tsx:58',message:'handleFlightSelect called',data:{flightId:flight.id,from:flight.from,to:flight.to},timestamp:Date.now()})}).catch(()=>{});
    // #endregion
